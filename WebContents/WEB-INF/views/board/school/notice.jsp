...
<body>
	...
	<div class="my-3">
		<form action="${contextPath}/board/list/school/notice" method="get" class="form-inline searchForm">
			...
			<div class="form-group mr-2">
			 ...
			 <div class="form-group">
			 	<a href="${contextPath}/board/list/school/notice" type="button" class="btn btn-primary">새로고침</a>
			 </div>
		</form>
	</div>
	<table class="table">
