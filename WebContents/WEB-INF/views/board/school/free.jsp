...
<body>
	...
	<div class="my-3">
		<form action="${contextPath}/board/list/school/free/" method="get" class="form-inline searchForm">
		<select class="form-control mr-2 category">
			...
			<div class="form-group">
			 	<a href="${contextPath}/board/list/school/free" type="button" class="btn btn-primary">새로고침</a>
			</div>
		</form>
	</div>
	<table class="table">
